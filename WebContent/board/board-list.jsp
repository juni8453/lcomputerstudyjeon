...
<table>
	...
	<%//item - collection 객체, var - 사용할 변수, varStatus - 반복 index 변수 %>
		<tr>
			...
			<td><a href = "board-reply.do?b_idx=${boardlist.b_idx }&b_group=${boardlist.b_group }&b_depth=${boardlist.b_depth}&b_order=${boardlist.b_order}&b_step=${boardlist.b_step}"><button style="margin-left:20px;">답글작성</button></a></td>
